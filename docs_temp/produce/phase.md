...
## Phase 1.5 — 생산 라인 실시간 처리 (model_agent의 Sample/Order API, data_agent의 저장소 API 확정 후 시작)
...
## 산출물
- `model/ProductionLine.h` (+ .cpp) 또는 별도 `produce/ProductionScheduler.h` — orchestrator와 배치 위치 협의
